...
const Auth = () => {
    ...
    return (
        <motion.div className="Auth" variants={authPageFadeInVariants} initial="initial" animate="animate" exit="exit">
            <div className="Auth__opacityLayer" />
            <div className="Auth__bgLayer" style={{ backgroundImage: `url(${SIGNIN_BGIMG_URL})` }} />
            <Link to="/" className="Auth__logo">
                <img className="Auth__logo--img" src={LOGO_URL} alt="Macrometa_logo" />
            </Link>
            <motion.div
            ...
            >
                <motion.div variants={staggerOne} initial="initial" animate="animate" exit="exit">
                    ...
                    {authError && (
                        <motion.p variants={authFadeInUpVariants} className="Auth__content--errors">
                            {authError}
                        </motion.p>
                    )}
